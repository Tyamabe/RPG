...
public class Main {
	public static void main(String[] args) {
		...
		while (true) {
			...
			// 人間グループから1人選択
			Human humanRep = choiceHuman(humans);
			
			// モンスターグループから1人選択
			Monster monsterRep = choiceMonster(monsters);
			...
			// 人間グループから1人選択
			humanRep = choiceHuman(humans);
			
			// モンスターグループから1人選択
			monsterRep = choiceMonster(monsters);
